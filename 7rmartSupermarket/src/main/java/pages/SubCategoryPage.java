...
public class SubCategoryPage {
	...
	private WebElement clickOnNewSubcategoryButton;
	...
	private WebElement enterSearchSubcategory;

	@FindBy(xpath = "//button[@class='close']")
	private WebElement alertSubcategory;
	// @FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/Subcategory/edit?edit=3193&page_ad=1']")private
	// WebElement searchSubcategoryUpdate;
	@FindBy(xpath = "//h4[text()='List Sub Categories']")
	private WebElement searchSubcategoryUpdate;
